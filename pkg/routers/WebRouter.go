...
import (
	"docker-manager/pkg/handler/agent"
	"docker-manager/pkg/handler/base"
	"docker-manager/pkg/handler/mgr"
	"docker-manager/pkg/handler/user"
...
var mgrRouter = func(router *boot.WebRouter) {
	...
	router.GET("/containerSize", AuthInterceptor, mgr.GetContainerSize)
